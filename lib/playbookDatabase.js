export const PLAYBOOK_DB = [
  ...
  },
  {
    ...
    category: "E-Mail-Versand",
    legalNote:
      "Resend ist ein US-Anbieter für transaktionale E-Mails. Prüfen: AVV vorhanden, Drittlandtransfer-Instrument, und ob E-Mail-Adressen/Inhalte korrekt in der Datenschutzerklärung als Verarbeitung durch Resend dokumentiert sind.",
  },
  {
    match: ["@netlify/functions", "netlify-cli", "netlify-lambda"],
    name: "Netlify",
    category: "Hosting/Deployment",
    legalNote:
      "Netlify (US-Anbieter) hostet App und/oder Serverless Functions, wodurch Anfragen (inkl. IP-Adressen) über Netlify-Infrastruktur laufen. Prüfen: AVV vorhanden, Serverregion/Edge-Standorte, Drittlandtransfer-Instrument, und Nennung in der Datenschutzerklärung.",
  },
  {
    match: ["@neondatabase/serverless", "neondatabase"],
    name: "Neon (Serverless Postgres)",
    category: "Datenbank",
    legalNote:
      "Neon ist ein Datenbank-as-a-Service-Anbieter mit Sitz in den USA. Prüfen: gewählte Datenbank-Region (EU verfügbar?), AVV vorhanden, und Drittlandtransfer-Instrument, falls personenbezogene Daten außerhalb der EU liegen.",
  },
  {
    match: ["@vercel/", "vercel"],
    name: "Vercel",
    category: "Hosting/Deployment",
    legalNote:
      "Vercel (US-Anbieter) hostet App und/oder Serverless/Edge Functions. Prüfen: AVV vorhanden, Serverregion/Edge-Standorte, Drittlandtransfer-Instrument, und Nennung in der Datenschutzerklärung.",
  },
  {
    match: ["@upstash/redis", "@upstash/kafka", "@upstash/qstash"],
    name: "Upstash",
    category: "Datenbank/Cache",
    legalNote:
      "Upstash ist ein US-Anbieter für serverloses Redis/Kafka/Messaging. Prüfen: gewählte Region (EU verfügbar?), AVV vorhanden, und ob dort personenbezogene Daten (z. B. Sessions, Rate-Limit-Keys mit IP-Bezug) zwischengespeichert werden.",
  },
  {
