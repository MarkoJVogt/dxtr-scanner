...
## Nächste Schritte
- **Auto-Deploy einrichten**, damit künftige Pushes nicht mehr manuell redeployt werden müssen — Schritt-für-Schritt-Anleitung liegt bereit unter [`docs/coolify-auto-deploy.md`](docs/coolify-auto-deploy.md) (GitHub-Webhook → Coolify, Secret, Auto-Deploy-Schalter). Braucht Coolify-Dashboard-Zugriff (Marko).
